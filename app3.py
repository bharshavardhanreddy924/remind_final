...
{{
    ...
    'home': 'You live in chennai with your daughter and her family.',
...
def fitness_analysis():
    try:
        ...
        # Simply render the template with hardcoded data
        return render_template('fitness_analysis.html', user=user)
    except Exception as e:
